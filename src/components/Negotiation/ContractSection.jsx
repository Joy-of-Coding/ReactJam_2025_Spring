...
const ContractSection = ({
  ...
  const buyerPersonaId =
    game.personas && buyerId ? game.personas[buyerId] : null;
  const buyerPersona =
    buyerPersonaId !== null
      ? carPersonas.find((p) => p.id === buyerPersonaId)
      : null;
    ...
    if (selectedCar) {
      ...
      if (buyerPersona) {
        ...
        const matchPercentage = Math.round(
          (matchScore / totalAttributes) * 100,
        );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3
            style={{ fontSize: "0.9rem", margin: "0", fontFamily: "cursive" }}
          >
        ...
        {isBuyer && carMatchScore !== null && (
          ...
          >
            <span>
              Car match: <strong>{carMatchScore}%</strong>
            </span>
            <div
              style={{
                width: "100%",
        ...
        >
          {isBuyer ? (
            <>
              <WalkAwayButton yourPlayerId={yourPlayerId} game={game} />

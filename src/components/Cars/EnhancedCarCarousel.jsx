          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: "4px",
                marginBottom: "0.5rem",
                backgroundImage: car.picture
                  ? `url(../../assets/img/${car.picture})`
                  : "none",
            ...
            <div
              style={{ fontSize: "0.75rem", marginBottom: "0.5rem", flex: 1 }}
            >
              <div>
                <strong>Type:</strong> {car.carType}
              </div>
              <div>
                <strong>Color:</strong> {car.colorModel}
              </div>
              <div>
                <strong>Safety:</strong> {car.safety}
              </div>
              <div>
                <strong>Maintenance:</strong> {car.maintenanceExpenses}
              </div>
            </div>

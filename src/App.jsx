...
import bgMusicLemon from "./assets/sound/freemusicbg.com-Easy Lemon.mp3"
// import selectSoundAudio from "./assets/select.wav";
const bgMusic = new Audio(bgMusicLemon);
...
function App() {
  ...
  return (
    <>
      {/* {!negotiationStarted && bgMusic} */}
    	{!gameStarted && !negotiationStarted && !choiceEnded && <StartScreen onStartGame={handleStartGame} yourPlayerId={yourPlayerId} game={game} />}
      {gameStarted && !negotiationStarted && !choiceEnded && <ChoicesScreen onEndGame={handleEndGame} onNegotiation={handleStartNegotiation} playerId={yourPlayerId} game={game}/>}
      {gameStarted && !negotiationStarted && choiceEnded && <GameScreen onEndGame={handleEndGame} onNegotiation={handleStartNegotiation} playerId={yourPlayerId} game={game}/>}
